Ext.define("com.coremedia.blueprint.social.messages.ChoiceDisplayField", function(ChoiceDisplayField) {/*package com.coremedia.blueprint.social.messages{
...
public class ChoiceDisplayField extends MessageDisplayFieldBase{
    ...
    public*/function ChoiceDisplayField$(config/*:ChoiceDisplayField = null*/){if(arguments.length<=0)config=null;
    ...
    var defaults_$1/*:ChoiceDisplayField*/ =AS3.cast(ChoiceDisplayField,{});
    ...
    this.super$LbgB(config_$1);
  }/*}}

============================================== Jangaroo part ==============================================*/
    return {
      extend: "com.coremedia.blueprint.social.messages.MessageDisplayFieldBase",
      alias: "widget.com.coremedia.blueprint.social.studio.config.message.field.choice",
      constructor: ChoiceDisplayField$,
      super$LbgB: function() {

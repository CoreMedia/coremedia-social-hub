Ext.define("com.coremedia.blueprint.social.messages.TextDisplayField", function(TextDisplayField) {/*package com.coremedia.blueprint.social.messages{
...
public class TextDisplayField extends MessageDisplayFieldBase{
    ...
    public static const xtype:String = "com.coremedia.blueprint.social.studio.config.message.field.text";

    public*/function TextDisplayField$(config/*:TextDisplayField = null*/){if(arguments.length<=0)config=null;
    ...
    var defaults_$1/*:TextDisplayField*/ =AS3.cast(TextDisplayField,{});
    ...
    this.super$b_IN(config_$1);
  }/*}}

============================================== Jangaroo part ==============================================*/
    return {
      extend: "com.coremedia.blueprint.social.messages.MessageDisplayFieldBase",
      alias: "widget.com.coremedia.blueprint.social.studio.config.message.field.text",
      constructor: TextDisplayField$,
      super$b_IN: function() {

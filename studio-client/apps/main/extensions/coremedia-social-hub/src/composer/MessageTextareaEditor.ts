...
class MessageTextareaEditor extends MessageTextareaEditorBase{
  ...
  items:[
    ...
    Config(Container, {
      items:[
        Config(IconButton, { itemId:  MessageTextareaEditor.EXTERNAL_LINK_BUTTON_ITEM_ID,
        ...
        Config(IconButton, { itemId:  MessageTextareaEditor.INTERNAL_LINK_BUTTON_ITEM_ID,
        ...
        Config(MessageCharacterCounter, { bindTo: config.bindTo, adapter: config.adapter})
      ],
      layout: Config(HBoxLayout, { align: "stretch"
      })
    }),
    Config(MessageRichtextArea, { itemId: "richtextEditor", bindTo: config.bindTo})
  ],

...
class MessageFooter extends MessageFooterBase{
  ...
  items:[
      ...
      items:[
        Config(Container, {
          items:[
            Config(Container, {
              items:[
                Config(DisplayField, { ui: ConfigUtils.asString( null), style: this.getDateLabelStyle(config.message), html: true,
                              value: "<b>" + this.getDateLabel(config.message) + "<\/b>"}),
                Config(DisplayField, { ui: ConfigUtils.asString( null), width: 280, value: config.message.getErrorMessage(), style: "color: #FFF !important;",
                  plugins:[
                ...
                Config(DisplayField, {
                  plugins:[
                    Config(BindPropertyPlugin, { transformer: bind(this,this.transformDate),
            ...
            Config(Button, { itemId: "openInBrowserButton",
        ...
        Config(Container, {
          items:[
            Config(CounterLabel, { adapter: config.adapter, message: config.message,
    ...
    Config(Button, { itemId: "deleteButton",
    ...
    Config(Button, { itemId: "deleteFromErrorButton",
            ui:  ButtonSkin.MATERIAL_SECONDARY.getSkin(),
    ...
    Config(Button, { itemId: "retryFromErrorButton",
            style: "background-color: #FFF !important;",
            ui:  ButtonSkin.MATERIAL_SECONDARY.getSkin(),

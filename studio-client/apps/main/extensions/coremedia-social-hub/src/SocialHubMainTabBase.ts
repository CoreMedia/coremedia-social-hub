...
class SocialHubMainTabBase extends Panel {
  ...
  protected override afterRender():void {
    super.afterRender();
    var adapterExpre = socialHubService.getAdaptersExpression();
  ...
  #loadAdapterList(adapters:Array<any>):void {
    ...
    for(var a of adapters as SocialHubAdapterImpl[]) {
      a.load(():void => {
        this.#adapterCount++;
        var progress:number = this.#adapterCount / adapters.length;

  ...
  constructor(config: Config<SocialNotificationToast> = null) {
    super((()=> ConfigUtils.apply(Config(SocialNotificationToast, {
      ...
      items: [
        Config(Component, {
          width: 6,
          style: "background-color:" + SocialNotificationToast.#getStatusColor(config.notificationValidationState) + ";",
        }),
        Config(Container, {
          width: 32,
          items: [
            Config(IconDisplayField, {
              iconCls: CoreIcons_properties[SocialNotificationToast.#getStatusIcon(config.notificationValidationState)],
          ...
          items: [
            Config(Container, {
              ...
              items: [
                Config(Container, {
                  ...
                  items: [
                    Config(DisplayField, {
                      ...
                      value: config.notificationSource + ":",
                    }),
                ...
                Config(DisplayField, {
                  html: true,
                  style: "color:#646060 !important;padding-top:8px;",
                ...
                Config(Container, {
                  ...
                  plugins: [
                    Config(BindVisibilityPlugin, { bindTo: ValueExpressionFactory.createFromValue(config.notificationAction) }),
                  ],

  ...
  constructor(config: Config<MessagesContainer> = null) {
    super((()=> ConfigUtils.apply(Config(MessagesContainer, {
      ...
      items: [
        Config(Container, {
          ...
          items: [
            Config(DisplayField, {
              ...
              style: CustomStyles.TITLE_MEDIUM,
            }),
            Config(DisplayField, {
              value: SocialHub_properties.channel_queue_subtitle,
              plugins: [
            ...
            Config(DisplayField, {
              ...
              plugins: [
                Config(BindVisibilityPlugin, {
                  transformer: (messages: Array<any>): boolean => messages.length === 0,
        ...
        Config(Container, {
          itemId: MessagesContainer.MESSAGES_CONTAINER_ITEM_ID,
          style: "padding: 2px;",
          items: [

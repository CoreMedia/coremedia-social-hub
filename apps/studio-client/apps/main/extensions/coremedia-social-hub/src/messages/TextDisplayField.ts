...
interface TextDisplayFieldConfig extends Config<MessageDisplayFieldBase> {
}


class TextDisplayField extends MessageDisplayFieldBase{
  declare Config: TextDisplayFieldConfig;

  static override readonly xtype:string = "com.coremedia.blueprint.social.studio.config.message.field.text";

  constructor(config:Config<TextDisplayField> = null){
    super((()=> ConfigUtils.apply(Config(TextDisplayField, {

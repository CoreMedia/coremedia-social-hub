...
class MessageTextareaEditorBase extends Panel implements MessageFieldEditor {
  ...
  protected override afterRender(): void {
    super.afterRender();
    const ckEditor = this.getRichtextEditor().getCKEditor();
  ...
  #valueChanged(ve: ValueExpression): void {
    const editor: any = this.getRichtextEditor();
  ...
  protected openExternalLinkDialog(): void {
    this.#externalLinkDialog = Ext.create(ExternalLinkDialog, { messageEditor: this });
  ...
  getErrorMessage(): string {
    ...
    let plain = RichTextPlainTextTransformer.convertToPlainText(value);

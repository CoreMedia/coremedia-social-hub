...
class ChannelContainer extends ChannelContainerBase {
  ...
  constructor(config: Config<ChannelContainer> = null) {
    super((()=> ConfigUtils.apply(Config(ChannelContainer, {
      ...
      items: [
        Config(SwitchingContainer, {
          ...
          items: [
            ...
            Config(Panel, {
              itemId: ChannelContainerBase.DROP_CONTENT_ITEM_ID,
              cls: "channel-drop-container",
              items: [
                Config(Container, { height: 100 }),
                Config(IconDisplayField, {
            ...
            Config(Panel, {
              itemId: ChannelContainerBase.DROP_CONTENT_AND_LINK_ITEM_ID,
              items: [
                Config(Container, {
                  flex: 1,
                  itemId: ChannelContainerBase.DROP_LINK_ITEM_ID,
            ...
            Config(Panel, {
              itemId: ChannelContainerBase.DROP_NOT_ALLOWED_ITEM_ID,
              cls: "channel-drop-container",
              items: [
                Config(Container, { height: 100 }),
                Config(IconDisplayField, {
            ...
            Config(Panel, {
              ...
              items: [
                Config(MessagesContainer, {
                  ...
                  plugins: [
                    Config(BindVisibilityPlugin, { bindTo: ValueExpressionFactory.createFromValue(config.adapter.isSchedulingSupported()) }),
                  ],
                }),
                Config(Container, {
                  height: 12,
      ...
      tbar: Config(Toolbar, {
        height: 44,
        style: "background-color:" + config.adapter.getColor(),
        items: [
          Config(Spacer, { width: 6 }),
          Config(IconDisplayField, {
            ui: IconDisplayFieldSkin.LIGHT.getSkin(),
            scale: "medium",
          ...
          Config(Container, {
            items: [
              Config(DisplayField, {
                ui: IconDisplayFieldSkin.LIGHT.getSkin(),
                value: config.adapter.getDisplayName(),
              }),
            ],
          ...
          Config(MenuIconButton, {
            itemId: ChannelContainer.COLOR_CHOOSER_BUTTON_ITEM_ID,
